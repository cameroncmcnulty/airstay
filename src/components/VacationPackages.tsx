      ...
      <div className="relative overflow-hidden rounded-[1.8rem] bg-navy text-white shadow-card sm:rounded-[2.2rem]">
        ...
        <div className="relative grid items-center gap-8 p-6 sm:p-10 lg:grid-cols-[1.15fr_auto]">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">{m.packages.title}</h2>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              ...
              {!compact && (
                <Link href="/packages" className="inline-flex items-center rounded-full bg-white/10 px-4 py-2.5 text-sm font-bold text-white ring-1 ring-white/20 hover:bg-white/15">
                  {m.nav.packages}
                </Link>
              )}
            </div>
          ...
          <div className="mx-auto w-full max-w-[320px] rounded-[1.4rem] bg-white p-3 shadow-lift ring-1 ring-white/40">
            <p className="mb-2 text-center text-[10px] font-black uppercase tracking-[0.18em] text-navy/45">
